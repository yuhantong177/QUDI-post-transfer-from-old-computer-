...
class TimeTaggerFastCounter(Base, FastCounterInterface):
    ...
    def configure(self, bin_width_s, record_length_s, number_of_gates=0):
        ...
        self.pulsed = tt.TimeDifferences(
            ...
            click_channel=1,
            start_channel=3,
            ### for autocorrelation measurements change next channel to 4
            ### for autocorrelation measurement the other apd will come to start_channel 3
            ### for regular pulsing change next channel to 3 and and start channel to 3
            next_channel=3,
